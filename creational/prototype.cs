...
на основе уже ранее созданных объектов-прототипов. То есть 
...
class Rectangle: IFigure
{
    ...
    public IFigure Clone() => new Rectangle(this.width, this.height);
...
class Circle : IFigure
{
    ...
    public IFigure Clone() => new Circle(this.radius);
